...
const validationSchema = z.object().shape({
  password: z.string().required('Password Required'),
  confirmPassword: z
    .string()
    .required('Confirm Password Required')
    .oneOf([z.ref('password')], 'Password not match'),
})
        ...
        return (
          <Form>
            <FormContainer>
              ...
              <FormItem label='Password' invalid={errors.confirmPassword && touched.confirmPassword} errorMessage={errors.confirmPassword}>
                <Field autoComplete='off' name='confirmPassword' placeholder='Confirm Password' component={Input} type='password' />
              </FormItem>
              <FormItem>
