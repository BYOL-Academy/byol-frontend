'use client'
import { gettingStartedRoutes, routes } from './webSrc/routes/routes'
import { Accordion, AccordionAction, AccordionContent, AccordionItem, AccordionTitle } from './webSrc'
...
const DocSidebar = () => {
  ...
  return (
    <div className='hidden lg:col-span-3 lg:block xl:col-span-2'>
      <aside id='componentListSidebar' className='sticky top-28 h-[75vh] space-y-5 overflow-auto 2xl:top-56 2xl:py-6 2xl:pl-8'>
