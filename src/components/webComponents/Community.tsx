...
import { Avatar, AvatarFallback, AvatarGroup, AvatarImage } from './webSrc'
    ...
    <section className='community py-20'>
      <div className='mx-auto max-w-7xl px-6 py-6 2xl:px-0'>
        <div className='mb-12 text-center'>
          <h4 className='mb-1 text-body-1 !font-semibold text-black lg:text-heading-5 dark:text-white'>Join The BYOL Community</h4>
          <p className='mx-auto max-w-sm text-body-4 font-normal text-metal-600 md:text-body-3 dark:text-metal-300'>Discussion groups for every exam</p>
        </div>
        <div className='grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4'>
          <div className='community-1'>
            <div className='flex items-center justify-center lg:justify-start lg:pl-14'>
              <div className='my-20'>
                ...
                <div className='mt-3'>
                  <p className='text-heading-6 font-semibold text-white lg:text-heading-5'>Join the BYOL community</p>
                  <p className='max-w-sm text-body-3 font-normal text-white/70'>Discussion groups for every exam</p>
                </div>
                <Link
          ...
          <Link to='https://x.com/byolacademy' target='_blank' className='community-2 group relative cursor-pointer'>
            <div className='p-7 lg:px-6 lg:py-7'>
              <div>
                {/* <svg xmlns='http://www.w3.org/2000/svg' width={44} height={44} viewBox='0 0 44 44' fill='none'>
                  <circle cx={22} cy={22} r='21.5' fill='#F9FAFB' fillOpacity='0.2' stroke='url(#paint0_linear_1549_6712)' />
                  <path
                  ...
                  />
                  <defs>
                    <linearGradient id='paint0_linear_1549_6712' x1='20.9339' y1='2.10708e-08' x2='20.9339' y2='36.6667' gradientUnits='userSpaceOnUse'>
                ...
                <svg xmlns='http://www.w3.org/2000/svg' width={44} height={44} viewBox='0 0 44 44' fill='none'>
                  ...
                  />
                  <defs>
                    <linearGradient id='paint0_linear_1548_6698' x1='20.9339' y1='2.10708e-08' x2='20.9339' y2='36.6667' gradientUnits='userSpaceOnUse'>
                      <stop stopColor='white' stopOpacity='0.7' />
                      <stop offset={1} stopColor='white' stopOpacity='0.07' />
                    </linearGradient>
                  </defs>
              ...
              <div className='mt-5'>
                ...
                <p className='text-body-3 font-normal text-white'>Stay Updated with the Latest Tweets on Current Affairs</p>
              </div>
            </div>
          ...
          <Link to='' target='_blank' className='community-3 group relative cursor-pointer'>
            <div className='p-7 lg:px-6 lg:py-7'>
              <div>
                <svg xmlns='http://www.w3.org/2000/svg' width={44} height={44} viewBox='0 0 44 44' fill='none'>
                  <path
                  ...
                  />
                  <path
                    d='M31 15.8182C31 15.0233 30.3582 14.375 29.5707 14.375H14.4293C13.6418 14.375 13 15.0233 13 15.8182V30.1818C13 30.9767 13.6418 31.625 14.4293 31.625H29.5707C30.3582 31.625 31 30.9767 31 30.1818V15.8182ZM18.0343 28.7841H15.4735V20.0838H18.0343V28.7841ZM16.7539 18.9875C15.8989 18.9875 15.2064 18.2871 15.2064 17.4214C15.2064 16.5557 15.8989 15.8553 16.7539 15.8553C17.6089 15.8553 18.3014 16.5557 18.3014 17.4214C18.3014 18.2871 17.6089 18.9875 16.7539 18.9875ZM28.5264 28.7841H25.9693V24.625C25.9693 23.6357 25.9489 22.3694 24.6118 22.3694C23.2543 22.3694 23.0482 23.4426 23.0482 24.5534V28.7841H20.4911V20.0838H22.9439V21.1804H22.9814C23.3293 20.5398 24.1532 19.8628 25.3861 19.8628C27.9811 19.8628 28.5264 21.6602 28.5264 23.9886V28.7841Z'
                    fill='white'
                  />
                  <defs>
                    <linearGradient id='paint0_linear_1548_6698' x1='20.9339' y1='2.10708e-08' x2='20.9339' y2='36.6667' gradientUnits='userSpaceOnUse'>
              ...
              <div className='mt-5'>
                <p className='mb-1 text-body-2 font-medium text-white'>Linkedin</p>
                <p className='text-body-3 font-normal text-white/70 lg:max-w-[220px]'>Stay Updated with the Latest Articles on our Linkedin Page</p>
              </div>
            </div>
            <button className='invisible absolute right-5 top-5 transition-all duration-300 group-hover:visible'>
              <ArrowLineUpRight size={20} color='white' />
          ...
          <Link target='_blank' to='https://discord.com/invite/' className='community-4 group relative cursor-pointer'>
            <div className='flex flex-col items-start gap-4 p-7 lg:flex-row lg:px-6 lg:py-7'>
              <div>
                <svg xmlns='http://www.w3.org/2000/svg' width={44} height={44} viewBox='0 0 44 44' fill='none'>
                  ...
                  />
                  <defs>
                    <linearGradient id='paint0_linear_1549_6730' x1='20.9339' y1='2.10708e-08' x2='20.9339' y2='36.6667' gradientUnits='userSpaceOnUse'>
                      <stop stopColor='white' stopOpacity='0.7' />
                      <stop offset={1} stopColor='white' stopOpacity='0.07' />
                    </linearGradient>
                  </defs>
              ...
              <div>
                <div>
                  <p className='mb-1 text-body-2 font-medium text-white'>Student Discord Community</p>
                  <p className='max-w-md text-body-3 font-normal text-white/70'>Join peers, clear doubts, share tips, and stay exam-ready together.</p>
                </div>
              </div>
            </div>
            <button className='invisible absolute right-5 top-5 transition-all duration-300 group-hover:visible'>
