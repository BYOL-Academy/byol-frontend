...
const Step1 = ({ onNext, onSkip }: Step1Props) => {
  return (
    <div className='text-center'>
      <DoubleSidedImage className='mx-auto mb-8' src='/img/others/welcome.png' darkModeSrc='/img/others/welcome-dark.png' alt='Welcome' />
      <h3 className='mb-2'>Welcome on Board, lets get started with Byol</h3>
