...
const Authentication = () => {
  return (
    <>
      <p>Byol provides an implementation for JWT authorization that allows you to quickly link up your backend services.</p>
      <p>
        We are using <code>localStorage</code> & Redux to store authentication info. As we mentioned in our <strong>Redux guide</strong>, we use{' '}
      ...
      <div className='mt-10' id='useAuth'>
        <h5>useAuth hook</h5>
        <p>
          We have created a hook that returns all the necessary method you might need to authenticate a user like <strong>signIn</strong>, <strong>signOut</strong>,{' '}
...
const signIn = async (values: SignInCredential) => {
    try {
      ...
      <div className='mt-10' id='useAuth'>
        <h5>AuthService</h5>
        <p>
          We also created a series of default authentication services under <code>src/services/AuthService.ts</code>, each service method works coresponded <code>useAuth</code>{' '}
          fuction.
        </p>
