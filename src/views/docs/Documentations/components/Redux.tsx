  ...
  return (
    <>
      <p>
        ...
        is a popular application state management solution that can be integrated with front-end frameworks like React, it allows you to write scalable apps with maintainable
        codebases, however, using redux requires a lot of boilerplate code. To reduce the boilerplate codes and facilitate easier functionalities,{' '}
        <a href='https://redux-toolkit.js.org/' target='_blank' rel='noreferrer'>
          Redux toolkit (RTK)
        </a>{' '}
        is a better option, it comes with comes with built in Redux Thunk Middleware that use for asynchronous actions and standard way to writing Redux logic.
      </p>
      <p>
        You can find out Redux store configurations under <code>src/store/</code>, there&apos;s also several slice globally used as following:
      </p>
      <ul>
        <li>
          <strong>theme</strong>
      ...
      <p>
        ...
        to keep <code>auth</code>, <code>theme</code> & <code>locale</code> state alive in localStorage.
      </p>
      <div className='mt-10' id='codeSplitting'>
        <h5>Code Splitting</h5>
        <p className='mt-1'>
          We have implemented reducer injection approaches in our code base for a code splitting strategy, it can dynamically add reducers to the store when needed. Here is some
          example code for reducers registry:
        </p>
...
const YourComponent = () => {
	...
	return (
      ...
      <div className='mt-10' id='creatingNewSlice'>
        ...
        <p className='mt-1'>
          Slice is a collection of reducer logic and actions for a single feature, hence we sugguest to place slice file under your features module folder for better logic scoping.
...
export default yourSlice.reducer`}</SyntaxHighlighter>
      ...
      <div className='mt-10' id='creatingReduces'>
        ...
        <p className='mt-1'>You can define your reducers in slice as following code:</p>
        <SyntaxHighlighter language='ts'>{`import { createSlice } from '@reduxjs/toolkit'
...
export default yourSlice.reducer`}</SyntaxHighlighter>
      ...
      <p>
        ...
        documentation to better understand if you are not familiar redux-toolkit.{' '}
      </p>
      <div className='mt-10' id='rtkQuery'>
        <h5>RTK Query</h5>
        <p className='mt-1'>
          RTK Query is an exceptionally robust data fetching and caching tool along with Redux toolkit. In Byol, we have further enhanced its functionality by encapsulating a
          pre-configured RTK Query setup within the <code>src/service/RtkQueryService.ts</code>. If you prefer not to employ the useEffect hook for data fetching, you have the
          option to utilize the RtkQueryService and create an API instance within your slice.
        </p>
...
const YourComponent = () => {
	...
	return (
        ...
        <p>
          For more detailed information and additional examples, we recommend visiting the official RTK Query documentation site at{' '}
